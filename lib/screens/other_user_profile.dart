                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            //     title: 'Work',
                            //     content:
                            //         widget.cuser. 'Software Engineer at Google and microsoft',
                            //   ),
                            // ),
                          ],
                        ),
              ...
              MaterialButton(
                onPressed: () {
                  ...
                  FirebaseFirestore.instance
                      ...
                      .doc(widget.id)
                      .update({
                    'Full name': _name.text.isNotEmpty
                        ? _name.text.trim()
                        : widget.user.fullName,
                    // 'Town': _town.text.trim() ?? widget.user.address,
                    // 'Phone Number': _phone.text.trim() ?? widget.user.phone,
                    // 'School': _fromSchool.text.trim() ?? widget.user.school,
                    // 'Bio': _bio.text.trim() ?? widget.user.bio,
                    // 'work': _work.text.trim() ?? widget.user.work,
                  }).whenComplete(() {
                    // mySnackbar(context);
                    Navigator.push(
                        context,
