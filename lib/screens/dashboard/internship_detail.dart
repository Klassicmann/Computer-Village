...
class InternDetail extends StatefulWidget {
  final InternAppli appli;
  InternDetail({this.appli});

  @override
  _InternDetailState createState() => _InternDetailState();
}
                          ...
                          onPressed: () async {
                            ...
                            await FirebaseFirestore.instance
                              ...
                              FirebaseFirestore.instance
                                  ...
                                  .add({
                                    'title': 'Internship applictation to join Computer Village accepted',
                                'content':
                                    'Congratulations! Your applcation to join Computer village vocational trainning internship program has been accepted. We will get back to you very shortly',
                                'seen': false,
                                'time': DateTime.now(),
                                'initiator':
